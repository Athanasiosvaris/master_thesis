...
public class MqttConsumerBatches {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Topic[] topics = { new Topic("/home/fridge_batch", QoS.AT_LEAST_ONCE) };
			...
			while (true) {
				...
				mop_connection.publish("persistent://public/default/model60BatchesConsumeTopicBatches", Pulsar_message.getBytes(),
